...
const translations = {
  pt: {
    ...
    'modal.deposit.history.title': 'Histórico de Depósitos',
    'modal.deposit.history.totalDeposits': 'Total de Depósitos',
    'modal.deposit.history.totalValue': 'Valor Total',
    'modal.deposit.history.refresh': 'Atualizar',
    'modal.deposit.history.filter': 'Filtros',
    'modal.deposit.history.status.completed': 'Concluído',
    'modal.deposit.history.status.pending': 'Pendente',
    'modal.deposit.history.paymentMethod': 'PIX',
    'modal.deposit.history.noTransactions': 'Nenhuma transação encontrada',
    'modal.deposit.history.previous': 'Anterior',
    'modal.deposit.history.next': 'Próxima',
    'modal.deposit.history.page': 'Página',
    ...
    'Your recent withdrawals': 'Seus saques recentes',
    'Amount': 'Valor',
    'PIX Key': 'Chave PIX',
    'Status': 'Status',
    'Date': 'Data',
    ...
    'withdrawal': 'saque',
    'withdrawals': 'saques',
    'Make your first withdrawal to see it here': 'Faça seu primeiro saque para vê-lo aqui',
    'PIX key': 'Chave PIX',
    'Enter PIX key': 'Digite sua chave PIX',
  ...
  en: {
    ...
    'modal.deposit.history.title': 'Deposit History',
    'modal.deposit.history.totalDeposits': 'Total Deposits',
    'modal.deposit.history.totalValue': 'Total Value',
    'modal.deposit.history.refresh': 'Refresh',
    'modal.deposit.history.filter': 'Filters',
    'modal.deposit.history.status.completed': 'Completed',
    'modal.deposit.history.status.pending': 'Pending',
    'modal.deposit.history.paymentMethod': 'PIX',
    'modal.deposit.history.noTransactions': 'No transactions found',
    'modal.deposit.history.previous': 'Previous',
    'modal.deposit.history.next': 'Next',
    'modal.deposit.history.page': 'Page',
    ...
    'Your recent withdrawals': 'Your recent withdrawals',
    'Amount': 'Amount',
    'PIX Key': 'PIX Key',
    'Status': 'Status',
    'Date': 'Date',
    ...
    'Make your first withdrawal to see it here': 'Make your first withdrawal to see it here',
    'PIX key': 'PIX key',
    'Enter PIX key': 'Enter PIX key',
...
export function LanguageProvider({ children }: LanguageProviderProps) {
  ...
  // Update language based on user's account_mode with debouncing
  useEffect(() => {
