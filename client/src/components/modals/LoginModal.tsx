              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      {...form.register('phone')}
                      className="flex w-full border px-3 py-2 text-sm text-white pl-20 h-12 bg-gray-800/70 border-gray-600/50 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 rounded-xl transition-all duration-200 group-hover:border-gray-500 placeholder:text-gray-400 focus-visible:outline-none"
