              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-purple-300 text-sm">
                    {language === 'en' ? 'Game loaded successfully!' : 'Jogo carregado com sucesso!'}
                  </p>
                </div>
              </div>
              <button 
            ...
            <div className="p-6">
              <div className="text-center space-y-6">
                <div className="relative w-20 h-20 mx-auto">
                  <div className="w-20 h-20 bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-full flex items-center justify-center border border-green-500/30">
                    <Check className="h-10 w-10 text-green-400" />
                  </div>
                  <div className="absolute -top-1 -left-1 w-2 h-2 bg-green-400 rounded-full animate-ping opacity-60"></div>
                  <div className="absolute -bottom-1 -right-1 w-1.5 h-1.5 bg-green-400 rounded-full animate-ping opacity-60" style={{animationDelay: '0.5s'}}></div>
                </div>
                
                <div className="space-y-3">
                  <h3 className="text-xl font-bold text-green-400">
                    {language === 'en' ? 'Ready to Play!' : 'Pronto para Jogar!'}
                  </h3>
                  <p className="text-gray-300 leading-relaxed">
                    {language === 'en' 
                      ? `${game.name} has been loaded successfully. You can now start playing and enjoy the game!`
                      : `${game.name} foi carregado com sucesso. Você já pode começar a jogar e se divertir!`
                    }
                  </p>
                </div>
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  >
                    {language === 'en' ? 'Start Playing' : 'Começar a Jogar'}
                  </Button>
                  <Button
                    onClick={onClose}
                    variant="outline"
