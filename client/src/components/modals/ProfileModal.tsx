  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/90" onClick={handleModalClose}>
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div 
          className="relative max-w-sm w-[95%] mx-auto max-h-[85vh] overflow-hidden z-10"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative w-full">
                        ...
                        >
                          ...
                          {isEditing && <ChevronDown className="h-3 w-3 ml-2 opacity-50" />}
                        </button>
                        ...
                        {isEditing && showModeDropdown && (
                          <div className="absolute top-full left-0 mt-1 w-full bg-gray-800 border border-gray-700 rounded-md shadow-lg z-50 overflow-hidden">
                            <button
                              className="w-full px-3 py-2 text-left text-xs text-white hover:bg-gray-700 transition-colors"
