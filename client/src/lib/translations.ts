export const translations = {
  pt: {
    ...
    'Add balance to your account': 'Adicionar saldo à sua conta',
    'History': 'Histórico',
    ...
    'Advanced Player': 'Apostador Avançado',
    'You need to be an advanced player. Bet at least R$ 100.00 on any game to unlock exclusive promotions.': 'Você precisa ser um apostador avançado. Aposte pelo menos R$ 100,00 em qualquer jogo para liberar as promoções exclusivas.',
    ...
    'Manage your personal information': 'Gerencie suas informações pessoais',
    'Non-editable': 'Não editável',
    'Full Name': 'Nome Completo',
    'Account mode': 'Modo da Conta',
    'National': 'Nacional',
    'Brazil': 'Brasil',
